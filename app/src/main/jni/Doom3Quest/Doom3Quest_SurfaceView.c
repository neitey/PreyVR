...
JNIEXPORT jlong JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onCreate( JNIEnv * env, jclass activityClass, jobject activity,
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onStart( JNIEnv * env, jobject obj, jlong handle, jobject obj1)
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onResume( JNIEnv * env, jobject obj, jlong handle )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onPause( JNIEnv * env, jobject obj, jlong handle )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onStop( JNIEnv * env, jobject obj, jlong handle )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onDestroy( JNIEnv * env, jobject obj, jlong handle )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onSurfaceCreated( JNIEnv * env, jobject obj, jlong handle, jobject surface )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onSurfaceChanged( JNIEnv * env, jobject obj, jlong handle, jobject surface )
{
...
JNIEXPORT void JNICALL Java_com_lvonasek_rivensin_GLES3JNILib_onSurfaceDestroyed( JNIEnv * env, jobject obj, jlong handle )
{
