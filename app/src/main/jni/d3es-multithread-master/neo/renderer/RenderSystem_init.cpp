...
static void R_CheckPortableExtensions(void)
{
	...
	if (R_CheckExtension("GL_ARB_texture_compression") && R_CheckExtension("GL_EXT_texture_compression_s3tc")) {
		...
		glCompressedTexImage2DARB = (void (GL_APIENTRY *)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *))GLimp_ExtensionPointer("glCompressedTexImage2DARB");
		glGetCompressedTexImageARB = (void (GL_APIENTRY *)(GLenum, GLint, GLvoid *))GLimp_ExtensionPointer("glGetCompressedTexImageARB");
	} else
#endif
	{
	...
	if (glConfig.depthBoundsTestAvailable) {
		glDepthBoundsEXT = (void (GL_APIENTRY *)(GLclampd, GLclampd))GLimp_ExtensionPointer("glDepthBoundsEXT");
	}
#endif
